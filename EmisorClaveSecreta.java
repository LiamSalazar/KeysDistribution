        ...
        try {
            ...
            while (!conectado && intentos < maxIntentos) {
                try {
                    ...
                    Socket conexionChat = Conexiones.obtenerConexion(emisor.puertoEntrada, "127.0.0.1");
                    ...
                    intentos++;
                    try {
                        Thread.sleep(1000); // Espera 1 segundos antes de reintentar
